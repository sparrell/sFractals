...
main(_) ->
    ...
    ConfigMap = #{ fractalAlg => julian,  % Fractal Algorithm is julian
                    fractalImageFileName => "../examples/example7.png",  %image file created
                    dataFileName => "../examples/example7.erl.txt",  %data file
                    colorAlg => simple32,  % 0-31 map to colors
                    width => 4000,           % width=4k
